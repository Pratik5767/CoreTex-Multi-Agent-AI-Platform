...
// Color themes for different ppt attributes (text, heading, etc.)
const COLORS = {
    primary: "2563EB",
    secondary: "0F172A",
    text: "334155",
...
export const generatePPT = async (data) => {
    ...
    // setting metadata for generated slides
...
// Function for displaying cover of PPT
...
// Function for displaying all the slides in appropriate manner
const addContentSlide = (ppt, title, points, page, total) => {
    ...
    visiblePoints.forEach((point, index) => {
        ...
        slide.addShape(ppt.ShapeType.roundRect, {
            ...
            w: 12,
            h: 0.58,
            fill: { color: index % 2 ? '60A5FA' : 'EFF6FF' },
