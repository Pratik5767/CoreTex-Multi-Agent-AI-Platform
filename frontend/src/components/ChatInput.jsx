            ...
            <div className='flex flex-col gap-2 bg-white/3 border border-white/[0.07] rounded-2xl px-4 pt-3.5 pb-3'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <button
                        ...
                        disabled={!value}
                        className={`flex items-center justify-center w-8 h-8 rounded-lg border-none transition-all duration-150 ${value.trim() ? "bg-linear-to-br from-indigo-500 to-violet-700 hover:opacity-90 text-white cursor-pointer" : "bg-white/5 text-slate-600 cursor-not-allowed"}`}
                    >
                        <Send size={15} />
                    </button>
                </div>
