...
const MessageBubble = ({ role, content, images }) => {
    ...
    return (
        <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
            <div className={`w-fit max-w-[92vw] md:max-w-[72%] px-4 py-2.5 rounded-2xl wrap-break-word overflow-hidden leading-relaxed ${isUser ? "bg-linear-to-br from-indigo-500 to-violet-700 text-white rounded-tr-sm" : "bg-white/4 border border-white/[0.07] text-slate-200 rounded-tl-sm shadow-sm shadow-black/20"}`}>
                {
                    images.length > 0 && (
                            ...
                            return (
                                <div className='my-4 overflow-hidden rounded-xl border border-white/10 bg-[#111318]'>
                                    <div className='flex items-center justify-between bg-[#1b1d24] border-b border-white/10 px-4 py-2'>
                                        ...
                                        <button className='flex items-center gap-1 text-xs cursor-pointer' onClick={() => copyTheCode(value)}>
                                            {
                                                copyCode == value ?
                                                    <>
