                ...
                <>
                    ...
                    >
                        ...
                        <div className='flex items-center justify-between p-5 border-b border-white/10'>
                            ...
                            <button onClick={onClose} className='w-9 h-9 rounded-lg bg-white/5 hover:border-white/10 flex items-center justify-center cursor-pointer'>
                                ...
                                <div className='mt-5'>
                                    ...
                                    <div className='h-2 rounded-full bg-white/10 overflow-hidden'>
                                        <div
                                            ...
                                            style={{
                                                width: `${(
                                                    (userData.credits || 0) / (userData.totalCredits)
                                                ) * 100}%`
                                            }}
                                        />
                                    </div>
                        ...
                        <div className='px-5 flex-1 overflow-auto space-y-4'>
                            ...
                            <div className='rounded-xl border border-white/10 p-4'>
                                ...
                                <button onClick={() => handleUpgrade("starter")} className='mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white cursor-pointer'>Upgrade</button>
                            </div>
                            ...
                            <div className='rounded-xl border border-white/10 p-4'>
                                ...
                                <button onClick={() => handleUpgrade("pro")} className='mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white cursor-pointer'>Upgrade</button>
                            </div>
                        </div>
                    </motion.div>
                </>
